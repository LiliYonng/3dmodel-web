...
export default {
    ...
    methods: {
     init() {
            ...
            modelName = "model1";
            modelType = "obj";
            MTLLoad.load("/src/js/model/model1/model1.mtl", function (materials) {
                //obj的模型会和MaterialCreator包含的材质对应起来
                OBJLoad.setMaterials(materials);
                OBJLoad.load("/src/js/model/model1/model1.obj", function (obj) {
                model = obj;
            ...
            // 加载背景图片
            var texture = textureLoader.load("/src/js/bg.png");
