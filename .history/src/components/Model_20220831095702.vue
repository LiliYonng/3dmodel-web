<template lang="">
  ...
  <div class="right_aside"> > </div> -->
    ...
    <button @click="changeModel">下一个</button>
...
export default {
  ...
  methods: {
    ...
    loadObj: function () {
      ...
      let modelPath = this.curModel.path + this.curModel.name;
      switch (modelType) {
        case "obj": {
          const OBJLoad = new OBJLoader(); //obj加载器
          const MTLLoad = new MTLLoader(); //材质文件加载器
          //obj的模型会和MaterialCreator包含的材质对应起来
          MTLLoad.load(modelPath + ".mtl", function (materials) {
        ...
        case "gltf": {
          ...
          loader.load(modelPath + ".gltf", function (gltf) {
