...
export default {
    ...
    methods: {
     init() {
            ...
            modelName = "model1";
            modelType = "obj";
            let mtlModel = require("../js/model/model1/model1.mtl");
            MTLLoad.load(mtlModel, function (materials) {
            ...
            // 加载背景图片
            let bgImg = require("../js/bg.png")
            var texture = textureLoader.load(bgImg);
