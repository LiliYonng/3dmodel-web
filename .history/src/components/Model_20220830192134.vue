<template lang="">
  <div class="box">
    ...
    <div class="texuBtn" @click="changeMap('color2')">
				<img src="./model/model1/color_icon.jpg" id="color">
				<img src="./model/model1/specular_icon.jpg" id="specular">
				<img src="./model/model1/gilt_icon.jpg" id="gilt">
    </div>
  </div>
</template>
  ...
  methods: {
    init() {
      ...
      function render(){
        ...
        if (vm.myModel) {
          vm.myModel.rotation.y += 0.01; //每次绕y轴旋转0.01弧度
        }
        vm.controls.update();
      };
      render();
